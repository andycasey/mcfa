...
Chemical tagging describes the process of identifying individual star formation
sites based on the present day photospheric abundances of stars \citep{Freeman;Bland-Hawthorn:2001}.
Since the dynamical dissipation timescale for open clusters is relatively short
\citep[\todo{timescale}][]{}, the ability to identify star formation sites long
after the stars are no longer gravitationally bound could provide key insights
on the early formation of the disc of the Milky Way galaxy. For this reason,
much effort has been placed on obtaining observational data, methods for analysis,
theory, etc, in order to improve the prospects of chemical tagging.

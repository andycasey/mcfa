...
fig.savefig("toy-model-data.pdf", dpi=300)
fig.savefig("toy-model-data.png", dpi=150)



fig = mpl_utils.plot_latent_space(model, X)
fig.tight_layout()
fig.subplots_adjust(hspace=0, wspace=0)

fig.savefig("toy-model-latent-space.pdf", dpi=300)
fig.savefig("toy-model-latent-space.png", dpi=150)

...
$\NumLatentFactors = \todo{8}$ and $\NumComponents = 5$. 
...
preferred model, where the shaded regions indicate \emph{only} the projected uncertainty on
the rotation angles -- and does not include any uncertainty on the factor loads 
themselves.

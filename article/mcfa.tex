...
is represented by a mixture model of multivariate normal distributions
...
We find \todo{two} clusters are preferred in the \Galah\ data of 16 abundances
and 1,136 stars, which are representative of the [$\alpha$/Fe]-poor and 
[$\alpha$/Fe]-rich populations in the Milky Way disk. 
We expect more components
...
allowing model parameters to be optimised in a few minutes even given $\sim$$10^{7.5}$ 
...
\begin{figure}
	...
	\includegraphics[width=0.5\textwidth]{../experiments/exp2-specific-scatter.pdf}
...
\begin{comment}
\begin{figure}
	\includegraphics[width=0.45\textwidth]{experiments/exp4-abundance-counts.pdf}
...
data release. We express caution in directly interpreting those latent
factors, as our model explicitly requires mutually orthogonal latent factors.
We highlight potential extensions of this work that would efficiently deal with
missing and noisy data points.

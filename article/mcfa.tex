...
\begin{figure}
	\includegraphics[width=0.45\textwidth]{experiments/exp9-log-xfe-offset-subset-gridsearch-ll-contours.pdf}
	\includegraphics[width=0.45\textwidth]{experiments/exp9-log-xfe-offset-subset-gridsearch-bic-contours.pdf}
	\includegraphics[width=0.45\textwidth]{experiments/exp9-log-xfe-offset-subset-gridsearch-mml-contours.pdf}
    \caption{Model performance metrics resulting from a gridsearch using the
